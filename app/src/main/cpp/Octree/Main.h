//
// Created by B612 on 2019/7/2.
//

#ifndef OPENGLPROJECT_MAIN_H
#define OPENGLPROJECT_MAIN_H
 ...
 namespace std{
    ...
    public:
        ...
        void init() {
            ...
            LOGI(1, "Inserted points to octree\n");
        ...
        void testNaive() {
            ...
            LOGI(1, "testNaive found %ld points in %.5f sec.\n", results.size(), T);
        ...
        void testOctree() {
            ...
            double T = stopwatch() - start;
            LOGI(1, "testOctree found %ld points in %.5f sec.\n", results.size(), T);
